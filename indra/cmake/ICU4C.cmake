...
if (USESYSTEMLIBS)
  ...
  target_include_directories(ll::icu4c SYSTEM INTERFACE ${Icuuc_INCLUDE_DIRS})
  target_link_directories(ll::icu4c INTERFACE ${Icuuc_LIBRARY_DIRS})
  target_link_libraries(ll::icu4c INTERFACE ${Icuuc_LIBRARIES})
  return ()
endif ()
