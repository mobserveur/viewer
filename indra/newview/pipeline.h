...
public:
    ...
    bool allocateScreenBuffer(U32 resX, U32 resY, U32 snapshot_ = 0);
...
private:
    ...
    eFBOStatus doAllocateScreenBuffer(U32 resX, U32 resY, U32 snapshot_ = 0);
    void renderTriangle();
...
public:
    ...
    bool allocateScreenBufferInternal(U32 resX, U32 resY, U32 snapshot_ = 0);
